...
for VARIABLE in API_KEY APP_ID MEASUREMENT_ID BUCKET_URL PROJECT_ID STRIPE_PUBLISHABLE_KEY BUGSNAG_API_KEY LOGROCKET_APP_ID WS_RELAY_URL CODE_CHECK_URL IS_BURN
do
