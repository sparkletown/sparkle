const lost_soul_chamber_events = [
  {
    ...
    text:
      "Ask a burning question in a 1-2-1 chat, with a modern high priestess casting spells of hope in a violent world. Sessions are timed at 10min per seeker. You may want to bring your favouite dice to hand.",
    interactivity: "high",
  },
];
...
const roots_events = [
  {
    ...
    text:
      "Champagne reception early, with light jazz and affable chit-chat. Transitioning later into intimate conversation, meet-space.",
    interactivity: "high",
  },
  {
    start_hour: 4.5,
    ...
    text:
      "Ground yourself at the foundation of the party with our champagne reception. Light jazz, affable chit-chat: a place to get settled, make your first party friends.",
    interactivity: "high",
  },
];
...
const funk_in_the_trunk_common = {
  ...
  text:
    "Come dance with us in the Funk in the Trunk. Make sure to mute your microphone and grab the Twitch link to hear the music!",
  interactivity: "low",
};
...
const heart_room_events = [
  {
    ...
    text:
      "Tell us the name of your loved ones and it will appear in the animation!",
  ...
  },
  {
    ...
    text:
      "The Co-reality Collective would like to invite you to our trademark Midnight Ritual, a combination performance and interactive experience for everyone who comes to the Tree of Life.",
    interactivity: "medium",
  },
  {
    start_hour: 4.5,
    ...
    text:
      "Do you have stories about sexy ideas gone wrong, weird fantasies or unsuccessful flirting? Do you want a picture of it? Then join us as we share our true and somewhat embarrassing stories and get them illustrated live!",
    interactivity: "high",
  },
];
...
const mood_swing_common = {
  ...
  text:
    "Come hear the Lady Amelia Muchness discuss her sordid past alongside Dawn and a select few of her past lovers. Improv fans will have a ball - you may be lucky enough to be called upon to take part in the unfolding story, or you can watch from the sidelines!",
  interactivity: "high",
};
...
const treehouse_events = [
  {
    ...
    text:
      "Hosted by your Deer friends: Come watch insanely talented performers from all across the world dance with fire, hoops, feather fans, and more. Don't forget to play in our interactive laughing yoga workshop!",
    interactivity: "medium",
  },
  {
    start_hour: 5,
    ...
    name: "Aquatic Dance",
    text:
      "Courtney Wild Free is an embodied mermaid with a passion for inspiring, nurturing, serving, and illuminating conscious creative culture. This piece will be dedicated to the element of water, our ocean mother, and all there is to learn from being and flowing like this powerful cosmic liquid that heals.",
    interactivity: "medium",
  },
  {
    start_hour: 5.25,
    duration_hours: 0.08333333333333,
    host: "Cookie L'Amour",
    name: "Feather Fans",
    text: "",
    interactivity: "medium",
  },
  {
    ...
    duration_hours: 0.16666666666666,
    host: "Kolarova Dance",
  ...
  },
  {
    ...
    text:
      "One of the original 4 elements of hip-hop, breaking is a combination of dynamics, flexibility, and musicality.",
    interactivity: "medium",
  },
  {
  ...
  },
  {
    ...
    name: "Dance & Hoop",
    text:
      "A story about metamorphosis, told through embodied movement, flow arts, and dance.",
    interactivity: "medium",
  },
  {
    start_hour: 7.5,
...
const canopy_events = [
  {
    ...
    text:
      "Mescaline curious? Experienced practitioners share their love and respect for this beautiful and trustworthy plant medicine.",
  ...
  },
  {
    ...
    text:
      "Discover your origins. Explore light's restless journey from stars to chlorophyll, told through the lens of wild edible & medicinal plants.",
    interactivity: "medium, presentation with Q&As",
  },
  {
    start_hour: 6.5,
    ...
    text:
      "Expanding your consciousness and transforming your life with psychedelics from the animal kingdom.",
    interactivity: "medium, presentation with Q&As",
  },
  {
    start_hour: 7,
    ...
    text:
      "Round-circle exploration into the nature of reality. Fearlessly hosted by Dina Fisher with physicist Nir Lahav, specializing in fractal-based consciousness.",
  ...
  },
  {
    ...
    text:
      "Lean back, relax, and feel the magic wash over you. Perfect soft landing & after party.",
    interactivity: "low",
  },
];
...
const compost_heap_events = [
  {
    ...
    text:
      "A space away from the party: the compost heap at the Tree of Life. Impromptu conversations and magical connections while in line for the bathrooms.",
    interactivity: "high",
  },
];
