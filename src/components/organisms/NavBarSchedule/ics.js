...
export const ics = (uidDomain, prodId) => {
  ...
  return {
     ...
     * @param  {string} eventId     unique identifier
    ...
    addEvent: function (
        ...
        if (!rrule.rrule) {
          ...
          if (rrule.interval) {
            if (isNaN(parseInt(rrule.interval))) {
              throw error("Recurrence rrule 'interval' must be an integer");
            }
          }

          if (rrule.count) {
            if (isNaN(parseInt(rrule.count))) {
              throw error("Recurrence rrule 'count' must be an integer");
            }
          }
          ...
          if (typeof rrule.byday !== "undefined") {
            if (
              ...
              throw error("Recurrence rrule 'byday' must be an array");
            }
      ...
      var calendarEvent = [
        "BEGIN:VEVENT",
        "UID:" + eventId, //calendarEvents.length + "@" + uidDomain,
        "CLASS:PUBLIC",
