...
export class ViewportSystem extends System {
  ...
  addToEngine(engine: Engine) {
    ...
    Howler.mute(!GameInstance.instance.gameInstanceProvider.animatemap.environmentSound);
    ...
    const zoomLevel = GameInstance.instance.gameInstanceProvider.animatemap.zoomLevel;
  ...
  private _viewportZoomedEndHandler(viewport: Viewport) {
    ...
    GameInstance.instance.gameInstanceProvider.handleSetAnimateMapLastZoom(viewport.scale.y);
  }
