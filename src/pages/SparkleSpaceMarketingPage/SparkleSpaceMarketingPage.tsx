    ...
    <>
      ...
      <div className="detail">
        <p className="centered-text">
          ...
          a magical sub-universe of fun within the online Multiverse.
        </p>
        <p>
      ...
      <div className="detail">
        ...
        <p className="centered-text">
          We believe that Online experiences can have effects on consciousness
  ...
  return (
    <>
      <div className="full-page-container marketing-page">
        <div className="marketing-tab-bar">
