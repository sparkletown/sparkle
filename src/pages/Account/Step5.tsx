...
const videos: VideoDefinition[] = [
  ...
  {
    name: "Magic Man",
    text: "wants to talk about manifesting our dreams and the universal magic of Seed",
  ...
  },
  {
    ...
    text: "wants to remind you of the importance of reflecting on our principles and setting intentions",
  ...
  {
    name: "Consent",
    text: "Consent is an enthusiastic yes and must be sought in our interactions with others. This may be while entering their space or camp, or before becoming intimately acquainted. If you don't have an enthusiastic YES - you don't have consent. And of course, consent can be withdrawn at any time.",
  ...
  },
  {
    ...
    text: "Our community values creative cooperation and collaboration. We strive to produce, promote and protect social networks, public spaces, works of art, and methods of communication that support such interaction.",
  ...
  {
    name: "Gifting",
    text: "Burning Man is devoted to acts of gift giving. The value of a gift is unconditional. Gifting does not contemplate a return or an exchange for something of equal value.",
  ...
  {
    name: "Immediacy",
    text: "Immediate experience is one of the most important touchstones of value in our culture. We seek to overcome barriers that stand between us and a recognition of our inner selves, the reality of those around us, participation in society, and contact with a natural world exceeding human powers. ",
  ...
  {
    name: "Leave No Trace",
    text: "Our community respects the environment. We are committed to leaving no physical trace of our activities wherever we gather. We clean up after ourselves and endeavor, whenever possible, to leave such places in a better state than when we found them.",
  ...
  {
    name: "Participation",
    text: "Our community is committed to a radically participatory ethic. We believe that transformative change, whether in the individual or in society, can occur only through the medium of deeply personal participation. We achieve being through doing. Everyone is invited to work. Everyone is invited to play.",
  ...
  },
  {
    ...
    text: "Anyone may be a part of Burning Man. We welcome and respect the stranger. No prerequisites exist for participation in our community.",
  ...
  },
  {
    ...
    text: "We encourage the individual to discover, exercise and rely on their inner resources. Self-reliance means looking out for yourself and bringing everything you need.",
  ...
  },
  {
    ...
    text: "We value civil society. Community members who organise events should assume responsibility for public welfare and endeavor to communicate civic responsibilities to participants. They must also assume responsibility for conducting events in accordance with local, state and federal laws.",
  ...
  },
  {
    ...
    text: "Radical self-expression arises from the unique gifts of the individual. No one other than the individual or a collaborating group can determine its content. It is offered as a gift to others. In this spirit, the giver should respect the rights and liberties of the recipient.",
  ...
  },
  {
    ...
    text: "The intent of the Temple has always been quiet and introspective - as distinct from the focus of pretty much everything else at Seed which is tipped towards self expression. The Temple Burn is a time for quiet reflection - a release from the past and a look towards the future.",
