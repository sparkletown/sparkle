...
const Questions: React.FunctionComponent<PropsType> = ({ location }) => {
  ...
  const headerMessage =
    "To help other Hubbers find and get to know you, tells us a little about yourself.";

  console.log(venue.profile_questions);
  console.log(venue.profile_questions[0]);
